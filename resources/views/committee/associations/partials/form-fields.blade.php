...
<div class="space-y-4">
    ...
    <div>
        <label for="established_date" class="block text-sm font-medium text-gray-700">{{ __('Tarikh ditubuhkan') }}</label>
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        <div>
            <label for="postcode" class="block text-sm font-medium text-gray-700">{{ __('Poskod') }}</label>
            <input type="text" name="postcode" id="postcode" value="{{ old('postcode', $a?->postcode) }}"
                class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
    ...
    <div>
        <label for="state_id" class="block text-sm font-medium text-gray-700">{{ __('Negeri') }}</label>
        <select name="state_id" id="state_id" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <div>
        <label for="phone" class="block text-sm font-medium text-gray-700">{{ __('Telefon / hotline') }}</label>
        <input type="text" name="phone" id="phone" value="{{ old('phone', $a?->phone) }}"
            class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
        @error('phone')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
    </div>
    <div>
        <label for="official_email" class="block text-sm font-medium text-gray-700">{{ __('Emel rasmi') }}</label>
        <input type="email" name="official_email" id="official_email" value="{{ old('official_email', $a?->official_email) }}"
            class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
